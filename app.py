...
try:
    ...
    # print("Columns after loading CSV:", obesidade_df.columns.tolist())
except FileNotFoundError:
...
def comparison_graphs_page():
    ...
    try:
        ...
        no_cal_prob = obesidade_por_al_calorico[obesidade_por_al_calorico['al_calorico'] == 0]['obesidade'].iloc[0] if not obesidade_por_al_calorico[obesidade_por_al_calorico['al_calorico'] == 0].empty else 0
