...
def comparison_graphs_page():
    ...
    # Check if a prediction has been made on the main page
    # Commenting this out for now to allow viewing graphs without prediction
    # if 'prediction_made' not in st.session_state or not st.session_state.prediction_made:
    #     st.info("Insira os Dados na Primeira Página para visualizar os gráficos.")
